...
stain_growth = ggplot(m_growth_strain, aes(period, growth, group = Strain, color = Strain)) + geom_line(size = 1) + 
  ...
  geom_abline(slope = 0)+ theme_cowplot()  +  theme(legend.position="none") 
#+ annotate("segment", x = 1, xend = 3, y= 4, yend = 4, size = 2) + annotate("text", x = 2, y = 4.8, label = "Early \n 0 to 10 days", size = 7) +   annotate("segment", x = 6, xend = 9, y= 7, yend = 7, size = 2) + annotate("text", x = 7.5, y = 7.8, label = "Late \n 28 to 56 days", size = 7) 
...
stain_growth_std = ggplot(m_growth_strain, aes(period, growth_std, group = Strain, color = Strain)) + geom_line(size = 1) + 
  ...
  theme(legend.position=c(0.85, 0.85)) + theme_cowplot()
...
(stain_growth_f6 = f6_growth + geom_line(data = m_growth_strain, aes(period, growth, group = Strain, color = Strain), size = 1.5) + 
...
save_plot("~/Dropbox/labbio/seminarios/Defesa Doutorado/strain_growth-curves_2w.png", stain_growth,
          base_height = 6, base_aspect_ratio = 1.5)
save_plot("~/Dropbox/labbio/seminarios/Defesa Doutorado/strain_growth-curves_2w_std.png", stain_growth_std,
          base_height = 6, base_aspect_ratio = 1.5)
save_plot("~/Dropbox/labbio/seminarios/Defesa Doutorado/strain_growth-curves_f6_2w.png", stain_growth_f6,
